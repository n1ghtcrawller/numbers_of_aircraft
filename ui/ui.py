...
class Ui_input_values(object):
    def setupUi(self, input_values):
        ...
        self.centralwidget = QtWidgets.QWidget(input_values)
...
"font: 75 20pt \"Apple Symbols\";")
        ...
        self.cirID = QtWidgets.QLineEdit(self.centralwidget)
...
"border-radius: 30;")
        ...
        self.applic_vlalue = QtWidgets.QLineEdit(self.centralwidget)
...
"border-radius: 30;")
        ...
        self.result.setGeometry(QtCore.QRect(70, 380, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Apple Symbols")
        font.setPointSize(50)
        font.setBold(False)
...
"")
        ...
        self.descript = QtWidgets.QLineEdit(self.centralwidget)
        self.descript.setGeometry(QtCore.QRect(70, 460, 381, 81))
...
"    border: 2px solid rgb(59, 131, 189);")
        ...
        self.statusbar = QtWidgets.QStatusBar(input_values)
    ...
    def retranslateUi(self, input_values):
        ...
        self.label.setText(_translate("input_values", "<html><head/><body><p align=\"center\">Ввод данных для расчёта</p><p align=\"center\">строчных приемистостей</p></body></html>"))
